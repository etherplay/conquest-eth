...
This skill teaches how to use the Conquest.eth MCP server via mcporter to interact with a Conquest.eth game instance/
...
Use Conques.eth MCP when you need to:

- TODO

## Notes

- You do not need to use mcporter
- always use small radius (25 is a good number)
