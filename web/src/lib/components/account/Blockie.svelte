<script lang="ts">
  ...
  function update() {
    ...
    const yakuzaData = [
      // Row 1
      255, 0, 77, 255, 0, 0, 0, 255, 0, 0, 0, 255, 255, 255, 39, 255, 255, 255, 39, 255, 0, 0, 0, 255, 0, 0, 0, 255,
      255, 0, 77, 255,
      // Row 2
      255, 0, 77, 255, 255, 0, 77, 255, 255, 255, 39, 255, 0, 0, 0, 255, 0, 0, 0, 255, 255, 255, 39, 255, 255, 0, 77,
      255, 255, 0, 77, 255,
      // Row 3
      0, 0, 0, 255, 255, 0, 77, 255, 255, 255, 39, 255, 255, 255, 39, 255, 255, 255, 39, 255, 255, 255, 39, 255, 255, 0,
      77, 255, 0, 0, 0, 255,
      // Row 4
      0, 0, 0, 255, 0, 0, 0, 255, 255, 255, 39, 255, 0, 0, 0, 255, 0, 0, 0, 255, 255, 255, 39, 255, 0, 0, 0, 255, 0, 0,
      0, 255,
      // Row 5
      0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 255, 0, 77, 255, 255, 0, 77, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0,
      255,
      // Row 6
      0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0, 255, 255, 0, 77, 255, 255, 0, 77, 255, 0, 0, 0, 255, 0, 0, 0, 255, 0, 0, 0,
      255,
      ...
      255,
      // Row 8
      0, 0, 0, 255, 0, 0, 0, 255, 255, 0, 77, 255, 255, 0, 77, 255, 255, 0, 77, 255, 255, 0, 77, 255, 0, 0, 0, 255, 0,
      0, 0, 255,
    ];
