...
describe('CLI - Simulate', () => {
	...
	describe('simulate', () => {
		it('should simulate a fleet attack between two planets', async () => {
		...
		it('should return outcome with min/max capture information', async () => {
			expect(testPlanets.length).toBeGreaterThanOrEqual(2);
		...
		it('should return travel time and distance', async () => {
			expect(testPlanets.length).toBeGreaterThanOrEqual(2);
		...
		it('should return source planet attack/speed stats', async () => {
			expect(testPlanets.length).toBeGreaterThanOrEqual(2);
