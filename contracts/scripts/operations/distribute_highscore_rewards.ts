...
async function func(): Promise<void> {
  ...
  const highscore_rewards_str = await deployments.readDotFile('.highscore_rewards.json');
  const highscore_rewards: {address: string; reward: string}[] = JSON.parse(highscore_rewards_str);
